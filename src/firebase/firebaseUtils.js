...
export const goooglProvider = new firebase.auth.GoogleAuthProvider();
goooglProvider.setCustomParameters({ prompt: 'select_account' });

export const signInWithGoogle = () => auth.signInWithPopup(goooglProvider);
